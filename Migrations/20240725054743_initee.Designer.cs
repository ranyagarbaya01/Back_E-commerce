...
namespace store.Migrations
{
    ...
    [Migration("20240725054743_initee")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("store.Models.BasketItem", b =>
                {
                    ...
                    b.Property<string>("customerBasketeId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("customerBasketeId");
            ...
            modelBuilder.Entity("store.Models.BasketItem", b =>
                {
                    b.HasOne("store.Models.CustomerBasket", "customerBaskete")
                        .WithMany("Items")
                        .HasForeignKey("customerBasketeId");

                    b.Navigation("customerBaskete");
                });
